...
left_exampleDF
```
- joining to the LEFT (first data frame)
...
right_exampleDF
```
joins everything to the RIGHT, (table B)
...
full_exampleDF
```
- joins both completely, however lots of NA values
...
anti_exampleDF
```
- provides things that are missing in the second table 
...
I was thinking of using full join and joining by="Accession"
```{r}
