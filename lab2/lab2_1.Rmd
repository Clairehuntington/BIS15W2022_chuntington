...
This shows us when we have an unknown variable in a vector, that this will affect the mean calculation and it cannot accurately identify the mean since this unknown value will influence it. 
