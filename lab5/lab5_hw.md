...
```r
superhero_info <- rename(superhero_info,race = "Race", eye_color= "Eye color", hair_color="Hair color", height="Height", publisher="Publisher", skin_color="Skin color")
```
