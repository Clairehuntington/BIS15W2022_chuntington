...
```
## here() starts at /Users/clairehuntington/Desktop/BIS15W2022_chuntington
```
...
```
Yes everything appears to be tidy!
...
avg_entero %>% 
  pivot_wider(names_from=site,values_from=mean_enterococci_cfu_100ml) %>% 
  filter(year==2018) %>% 
  pivot_longer(-year, names_to = "site", values_to = "mean_enterococci_cfu_100ml")
```
...
##    <chr> <chr>                                        <dbl>
##  1 2018  Bondi Beach                                  22.9 
##  2 2018  Bronte Beach                                 43.4 
##  3 2018  Clovelly Beach                               10.6 
##  4 2018  Coogee Beach                                 21.6 
##  5 2018  Gordons Bay (East)                           17.6 
##  6 2018  Little Bay Beach                             59.1 
##  7 2018  Malabar Beach                                38.0 
##  8 2018  Maroubra Beach                                9.21
##  9 2018  South Maroubra Beach                         12.5 
## 10 2018  South Maroubra Rockpool                     112.  
## 11 2018  Tamarama Beach                               15.5
```
South Maroubra Rockpool was the most polluted beach during 2018. 
